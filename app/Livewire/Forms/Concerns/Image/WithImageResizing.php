...
trait WithImageResizing
{
    ...
    protected function storeStandardPicture(
        TemporaryUploadedFile $file,
        string $basename,
        ...
        return $this->storeTranscodedImage(
            ...
            basename: $basename,
            directory: $directory,
            profile: fn (ImageTranscoder $transcoder): ImageTranscoder => $this->applyStandardPictureProfile($transcoder, $file),
            disk: $disk,
        );
    }

    protected function applyStandardPictureProfile(ImageTranscoder $transcoder, TemporaryUploadedFile $file): ImageTranscoder
    {
